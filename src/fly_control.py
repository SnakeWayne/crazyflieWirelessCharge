...
class FlyControl():
    ...
    def switch_to_charge(formation_cf, charging_cf, status_list):
        ...
        while current_xy_distance < min_xy_distance:
            ...
            for i in range(len(status_list)):
                if(formation_cf_uri != status_list[i].uri and status_list[i].current_posture == FlyPosture.hover):
        ...
        while current_z_distance < min_z_distance:
            ...
            # 进行完for循环之后formation_cf与其他无人机不在同一个Z上
             ...
             for i in range(len(status_list)):
                 if status_list[i].uri != formation_cf_uri and status_list[i].current_posture == FlyPosture.hover:
        ...
        while current_z_distance < min_z_distance:
            for i in range(len(status_list)):
                if status_list[i].uri != charging_cf_uri and status_list[i].current_posture == FlyPosture.hover:
